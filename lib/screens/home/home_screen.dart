...
import 'package:vango_parent_app/supportbot/supportbot_fab.dart'; // <-- Add this line
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Theme.of(
        context,
      ).scaffoldBackgroundColor, // 👇 Updated to dynamic background
      floatingActionButton: const SupportbotFab(),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              ...
                              items: ['All', 'Important', 'Situational'].map((
                                String value,
                              ) {
                        ...
                        if (filteredNotifications.isEmpty)
                          ...
                          ...filteredNotifications
                              ...
                              .map(
                                (alert) =>
                                    _LiveNotificationCard(alertData: alert),
                              ),
  ...
  SliverAppBar _buildModernAppBar(int unreadCount) {
    ...
    return SliverAppBar(
      ...
      backgroundColor: Theme.of(
        context,
      ).scaffoldBackgroundColor, // 👇 Dynamic app bar background
  ...
  Widget _buildQuickStatusCard() {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient:
              AppColors.buttonGradient, // Keeps the beautiful dark gradient
  ...
  Widget _buildEmptyState() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(
          context,
        ).colorScheme.surface, // 👇 Dynamic surface color
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          color: isDark
              ...
              : AppColors.surfaceStrong, // 👇 Dynamic strong surface
          border: Border.all(
            color: Theme.of(context).dividerColor,
          ), // 👇 Dynamic border
        ),
...
class _LiveNotificationCardState extends State<_LiveNotificationCard> {
                    ...
                    child: FilledButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.of(context).pushNamed(
                          '/emergency_status',
                          arguments: {'emergencyId': referenceId},
                        );
                      },
                      child: const Text(
                        'View Live Map',
                    ...
                    child: TextButton(
                      style: TextButton.styleFrom(
                        ...
                        backgroundColor: isDark
                            ...
                            : Colors
                                  .grey
                                  .shade100, // 👇 Dynamic button background
                      ),
  ...
  Widget build(BuildContext context) {
    ...
    if (title.toLowerCase().contains('resolved') ||
        widget.alertData['notification_type'] == 'EMERGENCY_RESOLVED') {
      iconData = Icons.check_circle;
      iconColor = Colors.green;
      iconBgColor = Colors.green.withOpacity(0.15);
    } else if (title.toLowerCase().contains('breakdown') ||
        title.toLowerCase().contains('accident') ||
        title.toLowerCase().contains('medical') ||
        widget.alertData['notification_type'] == 'EMERGENCY_ALERT') {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Theme.of(
            context,
          ).colorScheme.surface, // 👇 Dynamic card background
          borderRadius: BorderRadius.circular(16),
          border: Border.all(color: Theme.of(context).dividerColor),
        ),
        child: Row(
